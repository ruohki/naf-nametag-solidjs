    ...
    /*
 	Bug-Fixed version from A-Frame Mirror Component by alfa256: 
	    ...
	    if(!this.done){
	      if( this.counter > 0){
	        ...
	        if(this.mesh){
				...
				target = this.el.object3D.getWorldPosition(target);
	            this.cam.position.copy(this.el.object3D.worldToLocal(target));
